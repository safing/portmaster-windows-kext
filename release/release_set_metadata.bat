...
set COMPINFO=/s company "Safing ICS Technologies GmbH" /s (c) "(c) %date:~10,4% Safing ICS Technologies GmbH"
set PRODINFO=/s product "Portmaster Windows Kernel Extension" /pv "1.0.3.0"
